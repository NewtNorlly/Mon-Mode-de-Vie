<p align="center">
  <img src="https://raw.githubusercontent.com/NewtNorlly/Mon-Mode-de-Vie/main/assets/avatars/host-mooncat.webp" width="96" alt="" />
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/themes-8-e8a838" alt="" />
...
八套主题色卡（默认「钴蓝」）、四种语言、二十五篇日记、七个相册、一个慢慢转的黑胶唱片。一间会客厅，左边是「去年今日」，右边是留言，中间是日历、日记、相册，顶上飘着一朵可以随时拉开的小云——换主题、切语言、读一封信。
...
`钴蓝` `妮珂` `石墨` `柑橘` `湖绿` `莺紫` `薰衣草` `陶土`

默认主题为「钴蓝」，小云设置里钴蓝色卡排在第一位。切换瞬间完成，零闪烁。
...
纯前端，无框架，无构建工具。CSS 自定义属性驱动八套主题，`data-theme` 属性一次切换全站。GitHub Actions 自动部署到 Pages，push 即上线。
